...
import com.tom.chef.BR

abstract class DataBindingRecyclerViewAdapter(viewModels: MutableList<ViewModel>) : RecyclerView.Adapter<DataBindingRecyclerViewHolder<*>>() {
