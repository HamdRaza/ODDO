...
class VariantItemAdopter(viewModels: MutableList<ViewModel>) : DataBindingRecyclerViewAdapter(viewModels) {
    ...
    init {
        mViewModelMap[VariantsViewModel::class.java] = R.layout.recycle_item_veriants
    }
